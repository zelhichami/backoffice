...
🎯 FOREGROUND PAIRING RULES
If --bg-section-primary is used → --fg-section-primary = color-primary but it should be more darker in the light mode to max and more lighter in the dark mode to max ( to avoid unread text)

If --bg-section-accent is used → --fg-section-accent = color-accent but it should be more darker to max in the light mode and more lighter to max in the dark mode ( to avoid unread text)
